<div class="ah-columns">
    <div class="ah-columns__side">
        <div class="ah-config-nav">
            <a href="#<?php echo $component['class'] ?>-ah-config" class="ah-config-nav__item ah-config-nav__item--is-active" data-behaviour="ah-change-tab">Asset Hound Config</a>
            <a href="#<?php echo $component['class'] ?>-default-attr" class="ah-config-nav__item" data-behaviour="ah-change-tab">Default Attributes</a>
